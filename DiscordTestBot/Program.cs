...
internal class Program
{
    ...
    private async Task MessageToChannelAsync(ulong userId)
    {
        ...
        await _client.GetGuild(1053851905291468930)
                     ...
                     .SendMessageAsync($"<@{userId}> Meowditation Time :3"); // geht evtl auch besser qwq
    }
    ...
    public async Task StartBotAsync()
    {
        ...
        await _client.SetCustomStatusAsync("rechtsanwalt nick sarafi sers! 🤨uhm..."); // set discord status, duh
